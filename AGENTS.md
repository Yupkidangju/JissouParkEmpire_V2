...
**[System Directive]**
이 문서는 현재 작업 공간에서 동작하는 **에이전트**가 최우선으로 참조해야 하는 전역 행동 지침(Master System Prompt)입니다. 에이전트는 사용자의 요청을 처리하거나 코드를 생성/수정할 때, 아래 15가지의 규칙을 단 하나도 누락 및 축약하지 말고 절대적으로 준수해야 합니다.
